...
export const MaterializedViewDetails: React.FC<MaterializedViewDetailsProps> = ({
  materializedViewId,
}) => {
  const { findMaterializedView, updateMaterializedView, addGrant, revokeGrant } =
    useDesignerStore();
    ...
    return (
      <div className="view-details">
        <div className="empty-state">
          <p>Materialized view not found</p>
        </div>
      </div>
    );
  }
  ...
  const saveProps = () => {
    ...
    updateMaterializedView(materializedViewId, m.definition ?? "SELECT 1", deps, {
      comment: editComment.trim() || undefined,
      refreshSchedule: editSchedule.trim() || undefined,
    });
    ...
    <div className="view-details">
      <div className="view-header">
        <div className="view-title">
          ...
          <h2>
            {catalog.name}.{schema.name}.{m.name}
          </h2>
        </div>
        <span
      ...
      <div className="view-section">
        <div className="section-header">
          <h3>Properties</h3>
          {!editingProps ? (
            <VSCodeButton appearance="secondary" onClick={startEditProps}>
              Edit
            </VSCodeButton>
          ) : (
            <>
              <VSCodeButton appearance="primary" onClick={saveProps}>
                Save
              </VSCodeButton>
              <VSCodeButton appearance="secondary" onClick={cancelEditProps}>
                Cancel
              </VSCodeButton>
            </>
          )}
        ...
        <div className="section-header">
          ...
          {!isEditing ? (
            <VSCodeButton
              ...
              onClick={() => {
                setEditedDefinition(m.definition ?? "");
                setIsEditing(true);
              }}
            >
              Edit
            ...
            <>
              <VSCodeButton appearance="primary" onClick={handleSaveDefinition}>
                Save
              </VSCodeButton>
              <VSCodeButton appearance="secondary" onClick={() => setIsEditing(false)}>
                Cancel
              </VSCodeButton>
            </>
          )}
      ...
      <div className="view-section">
        ...
        {isEditingDeps ? (
          ...
          <div className="dependencies-container">
            ...
            {!m.extractedDependencies?.tables?.length &&
              !m.extractedDependencies?.views?.length && (
              ...
              <VSCodeButton
                onClick={() => {
                  ...
                  if (principal && privs.length > 0) {
                    if (editingGrant)
                      revokeGrant("materialized_view", materializedViewId, editingGrant.principal);
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", gap: "8px", justifyContent: "flex-end" }}>
              ...
              <VSCodeButton
                onClick={() => {
                  revokeGrant("materialized_view", materializedViewId, revokeGrantDialog.principal);
