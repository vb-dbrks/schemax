...
export default {
  "title": "Schematic",
  "tagline": "Open source: multi-provider data catalog schema management with version control. Python SDK on PyPI · VS Code extension on Marketplace.",
  "favicon": "img/favicon.svg",
  "url": "https://github.com",
  "baseUrl": "/schemax-vscode/",
  "trailingSlash": true,
  "organizationName": "schematic",
  "projectName": "schemax-vscode",
  "onBrokenLinks": "throw",
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2026 Schematic. Open source. Docs built with Docusaurus.",
      "style": "light"
    },
    "prism": {
      "theme": {
