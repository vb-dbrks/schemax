...
def test_drop_schema_generates_sql() -> None:
    ...
    drop_schema_op = builder.schema.drop_schema("sch_product")
...
def test_drop_catalog_generates_sql() -> None:
    ...
    builder = OperationBuilder()
    drop_catalog_op = builder.catalog.drop_catalog("cat_test")
...
def test_drop_table_generates_sql() -> None:
    ...
    builder = OperationBuilder()
    drop_table_op = builder.table.drop_table("tbl_customer")
...
def test_multiple_drop_operations_different_objects() -> None:
    ...
    builder = OperationBuilder()
    drop_table_op = builder.table.drop_table("tbl_orders")
    drop_schema_op = builder.schema.drop_schema("sch_product")
...
def test_drop_operations_not_batched_with_create() -> None:
    ...
    builder = OperationBuilder()
    add_schema_op = builder.schema.add_schema("sch_new", "new_schema", "cat_1")
    drop_schema_op = builder.schema.drop_schema("sch_old")
...
def test_rollback_scenario_v0_2_to_v0_1() -> None:
    ...
    rollback_ops = [
        ...
        builder.table.drop_table("tbl_product"),
        # Then drop the product_360 schema
        builder.schema.drop_schema("sch_product"),
    ]
