...
**GitHub Pages**: Enable Pages (Settings → Pages → GitHub Actions), then push a version tag (e.g. `v0.2.0`) or run the **Docs Release** workflow manually. See [schematic/README.md](schematic/README.md) for details.
