...
unity_operation_metadata = [
    ...
    OperationMetadata(
        ...
        display_name="Add Volume",
        description="Create a managed or external volume in a schema",
        category=OperationCategory.SCHEMA,
        required_fields=["volumeId", "name", "schemaId", "volumeType"],
        optional_fields=["comment", "location"],
        is_destructive=False,
        managed_category=ManagedCategory.VOLUME_STRUCTURE,
    ),
    OperationMetadata(
        type=UNITY_OPERATIONS["RENAME_VOLUME"],
        display_name="Rename Volume",
    ...
    OperationMetadata(
        ...
        display_name="Drop Volume",
        description="Delete a volume",
        category=OperationCategory.SCHEMA,
        required_fields=[],
        optional_fields=["name", "catalogId", "schemaId"],
        is_destructive=True,
        managed_category=ManagedCategory.VOLUME_STRUCTURE,
    ),
    # Function operations
    OperationMetadata(
        ...
        display_name="Add Function",
        description="Create a SQL or Python function in a schema",
        category=OperationCategory.SCHEMA,
        required_fields=["functionId", "name", "schemaId", "language", "body"],
        optional_fields=["returnType", "returnsTable", "comment", "parameters"],
        is_destructive=False,
        managed_category=ManagedCategory.FUNCTION_STRUCTURE,
    ),
    OperationMetadata(
    ...
    OperationMetadata(
        ...
        display_name="Update Function",
        description="Update function body or signature",
        category=OperationCategory.SCHEMA,
        required_fields=[],
        optional_fields=["body", "returnType", "parameters", "comment"],
        is_destructive=False,
        managed_category=ManagedCategory.FUNCTION_STRUCTURE,
    ),
    OperationMetadata(
        type=UNITY_OPERATIONS["DROP_FUNCTION"],
        display_name="Drop Function",
    ...
    OperationMetadata(
        ...
        display_name="Set Function Comment",
        description="Add or update function comment",
        category=OperationCategory.METADATA,
        required_fields=["functionId", "comment"],
        optional_fields=[],
        is_destructive=False,
        managed_category=ManagedCategory.GOVERNANCE,
    ),
    ...
    OperationMetadata(
        ...
        display_name="Add Materialized View",
        description="Create a materialized view in a schema",
        category=OperationCategory.TABLE,
        required_fields=["materializedViewId", "name", "schemaId", "definition"],
        optional_fields=[
            "comment",
            "refreshSchedule",
            "partitionColumns",
        ...
        is_destructive=False,
        managed_category=ManagedCategory.MATERIALIZED_VIEW_STRUCTURE,
    ),
    OperationMetadata(
        type=UNITY_OPERATIONS["RENAME_MATERIALIZED_VIEW"],
        display_name="Rename Materialized View",
    ...
    OperationMetadata(
        ...
        display_name="Update Materialized View",
    ...
    OperationMetadata(
        ...
        display_name="Drop Materialized View",
    ...
    OperationMetadata(
        ...
        display_name="Set Materialized View Comment",
        description="Add or update materialized view comment",
        category=OperationCategory.METADATA,
        required_fields=["materializedViewId", "comment"],
        optional_fields=[],
        is_destructive=False,
        managed_category=ManagedCategory.GOVERNANCE,
    ),
