    ...
    <div className="view-details">
      <div className="view-header">
        <div className="view-title">
          ...
          <h2>
            {catalog.name}.{schema.name}.{f.name}
          </h2>
        </div>
        <span
          className="view-badge"
          style={{ background: "var(--vscode-charts-orange)", color: "white" }}
        >
          FUNCTION
        </span>
      </div>
        ...
        <div className="modal" onClick={() => setReturnTypeDialog(false)} role="dialog">
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-buttons">
              ...
              <VSCodeButton appearance="secondary" onClick={() => setReturnTypeDialog(false)}>
                Cancel
              </VSCodeButton>
            </div>
          </div>
        ...
        <div className="modal" onClick={() => setBodyDialog(false)} role="dialog">
          ...
          >
            ...
            <div className="modal-buttons">
              ...
              <VSCodeButton appearance="secondary" onClick={() => setBodyDialog(false)}>
                Cancel
              </VSCodeButton>
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", gap: "8px", justifyContent: "flex-end" }}>
              ...
              <VSCodeButton
                onClick={() => {
                  revokeGrant("function", functionId, revokeGrantDialog.principal);
