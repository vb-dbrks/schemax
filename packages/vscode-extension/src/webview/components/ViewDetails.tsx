...
export const ViewDetails: React.FC<ViewDetailsProps> = ({ viewId }) => {
  ...
  const saveDeps = () => {
    updateView(viewId, view.definition, { tables: editedTables, views: editedViews });
    setIsEditingDeps(false);
  };

  const cancelEditDeps = () => {
    setIsEditingDeps(false);
  };
    ...
    <div className="view-details">
      ...
      <div className="view-section">
        ...
        {isEditingDeps ? (
          ...
          <div className="dependencies-container">
            {(view.extractedDependencies?.tables?.length ?? 0) > 0 && (
              <div className="dependency-group">
            ...
            {(view.extractedDependencies?.views?.length ?? 0) > 0 && (
              <div className="dependency-group">
