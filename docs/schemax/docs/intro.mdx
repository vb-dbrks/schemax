...
**New here?** Start with [Prerequisites](/docs/guide/prerequisites) and [Quickstart](/docs/guide/quickstart).  
**Only need CI/CD?** Go to [Git and CI/CD setup](/docs/guide/git-and-cicd-setup) to run SchemaX in Azure DevOps or GitHub Actions (non-interactive).
:::
...
Until then, install from source (see [Quickstart](/docs/guide/quickstart) and [Development](/docs/guide/development)).
:::
...
See [Environments and deployment scope](/docs/guide/environments-and-scope) for **full mode vs governance-only** and how to scope deployments to existing objects.
...
- **Databricks Asset Bundles integration** — generate DAB resource files with `schemax bundle` to deploy schema changes as serverless jobs alongside your existing DAB project

## Quick links

**For users** — Get started and use SchemaX:

- [Prerequisites](/docs/guide/prerequisites) — What you need before starting
- [Quickstart](/docs/guide/quickstart) — Get started with the extension and CLI
- [Setup](/docs/guide/setup) — Install extension, CLI, open a project
- [Authentication](/docs/guide/authentication) — How the CLI authenticates to Databricks (same locally and in CI/CD)
- [Environments and deployment scope](/docs/guide/environments-and-scope) — Configure environments, governance-only mode, existing objects
- [Unity Catalog grants](/docs/guide/unity-catalog-grants) — Manage GRANT/REVOKE on catalogs, schemas, tables, views
- **Only need CI/CD?** → [Git and CI/CD setup](/docs/guide/git-and-cicd-setup) — Run SchemaX in Azure DevOps or GitHub Actions (non-interactive)
- **Using Databricks Asset Bundles?** → [DAB integration](/docs/guide/databricks-asset-bundles) — Deploy schema changes as serverless jobs in your DAB project
- [Workflows](/docs/reference/workflows) — Greenfield, brownfield, apply and rollback
- [CLI Reference](/docs/reference/cli) — Commands and options
- [Architecture](/docs/guide/architecture) — Design and patterns
- [FAQ](/docs/reference/faq) — Common questions

**For contributors** — Develop, test, and contribute:

- [Development](/docs/guide/development) — Build, run, and extend SchemaX
- [Testing](/docs/reference/testing) — How to run and write tests
- [Provider contract](/docs/reference/provider-contract) — Implement a new catalog provider
- [Contributing](/docs/contributing/) — Code style, PR process, commit signing
