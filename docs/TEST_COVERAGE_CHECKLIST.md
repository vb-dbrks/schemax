...
This document turns **every scenario documented in [TESTING.md](TESTING.md)** into a coverage checklist so that release-ready test coverage explicitly includes each documented area.
