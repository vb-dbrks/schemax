...
**Before Starting:**
1. Read [Provider contract](/docs/reference/provider-contract) - Provider interface specification
2. Read [Development — Provider Development](/docs/guide/development#provider-development) - Step-by-step guide
...
See [Development — Provider Development](/docs/guide/development#provider-development) for complete guide.
...
See [Development](/docs/guide/development) for detailed setup instructions.
...
See [devops/README.md](https://github.com/vb-dbrks/schemax-vscode/blob/main/devops/README.md) for details.
...
We maintain a single documentation site (this Docusaurus site). **Do not create redundant documentation files.**

**Structure:**
- **Docusaurus** (`docs/schemax/`) — All user and contributor docs (Quickstart, Architecture, Development, Testing, Provider contract, Contributing, etc.).
- **Repo root** — `README.md` (project overview); `CONTRIBUTING.md` is a short pointer to this page.
- **Packages** — `packages/vscode-extension/README.md`, `packages/python-sdk/README.md` for package-specific notes.

### When to Update Documentation

**Feature added?** → Update:
- Root `README.md` (if user-facing)
- [Quickstart](/docs/guide/quickstart) or relevant guide (if affects usage)
...
- [Development](/docs/guide/development)
...
5. **Update documentation:**
   ...
   - [Architecture](/docs/guide/architecture) — If architecture impact
...
- **Stuck?** Check [Development](/docs/guide/development) and [Architecture](/docs/guide/architecture)
