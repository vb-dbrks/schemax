...
**Before Starting:**
1. Read [Provider contract](/reference/provider-contract) - Provider interface specification
2. Read [Development — Provider Development](/guide/development#provider-development) - Step-by-step guide
...
See [Development — Provider Development](/guide/development#provider-development) for complete guide.
...
- [Quickstart](/guide/quickstart) or relevant guide (if affects usage)
...
5. **Update documentation:**
   ...
   - [Architecture](/guide/architecture) — If architecture impact
...
- **Stuck?** Check [Development](/guide/development) and [Architecture](/guide/architecture)
