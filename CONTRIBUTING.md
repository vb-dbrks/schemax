...
- [Development setup](https://vb-dbrks.github.io/schemax/guide/development) — Build and run the extension and Python SDK
- [Testing](https://vb-dbrks.github.io/schemax/reference/testing) — Run tests and quality checks
- [Provider contract](https://vb-dbrks.github.io/schemax/reference/provider-contract) — Implement a new catalog provider
