...
check_contains packages/python-sdk/src/schemax/version.py "SCHEMAX_VERSION = \"$VERSION\""
check_contains packages/python-sdk/src/schemax/__init__.py "__version__ = SCHEMAX_VERSION"
check_contains packages/python-sdk/src/schemax/cli.py "CLI_VERSION = SCHEMAX_VERSION"
