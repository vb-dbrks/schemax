...
2. **Read Architecture**: See [Architecture](/guide/architecture).
3. **Project Lifecycle & Workflows**: See [Workflows](/reference/workflows) for single/multi-dev, greenfield/brownfield, and rollback timelines.
