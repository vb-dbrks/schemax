...
:::tip Bulk operations
To apply the same **grant** or **tag** to all objects in a catalog or schema, select the catalog or schema in the tree and click **Bulk operations** in the detail panel. Choose Add grant (principal + privileges) or Add tag, then Apply. See [Unity Catalog grants — Bulk grants and tags](/docs/guide/unity-catalog-grants/#bulk-grants-and-tags).
:::
