...
class TestRollbackPartial:
    ...
    @patch("schematic.commands.rollback.load_current_state")
    def test_rollback_with_safe_operations(self, mock_load_state):
        ...
        # Mock executor - successful execution
    ...
    @patch("schematic.commands.rollback.load_current_state")
    def test_rollback_blocks_on_destructive(self, mock_load_state):
    ...
    @patch("schematic.commands.rollback.load_current_state")
    def test_rollback_execution_failure(self, mock_load_state):
