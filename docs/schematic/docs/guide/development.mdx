...
See [Architecture](/guide/architecture) for detailed architecture documentation.
...
See [Architecture](/guide/architecture) for detailed design information.
...
**See also:** [Provider Contract](/reference/provider-contract) for detailed API documentation.
...
- **Provider Contract**: [Provider Contract](/reference/provider-contract)
...
- Review `.cursorrules` in the repo root for project context (or see [GitHub](https://github.com/schematic/schemax-vscode/blob/main/.cursorrules))
